  ...
  class Base
    ...
    def bn_build
...

      {
        ...
        'bn_compile_win_common'     => {
          :script_path  => 'bn/compile_win_common.groovy',
          :parameters   => [
            ['cmdline', '编译命令', @cmdline],
            ['force',   '全量编译', true],
            ['version', '版本号',   '']
        ...
        'bn_compile_win_iptn'       => {
          :script_path  => 'bn/compile_win_iptn.groovy',
          :parameters   => [
            ['cmdline', '编译命令', @cmdline],
            ['force',   '全量编译', true],
            ['version', '版本号',   '']
        ...
        'bn_compile_win_e2e'        => {
          :script_path  => 'bn/compile_win_e2e.groovy',
          :parameters   => [
            ['cmdline', '编译命令', @cmdline],
            ['force',   '全量编译', true],
            ['version', '版本号',   '']
        ...
        'bn_compile_win_naf'        => {
          :script_path  => 'bn/compile_win_naf.groovy',
          :parameters   => [
            ['cmdline', '编译命令', @cmdline],
            ['force',   '全量编译', true],
            ['version', '版本号',   '']
        ...
        'bn_compile_win_wdm'        => {
          :script_path  => 'bn/compile_win_wdm.groovy',
          :parameters   => [
            ['cmdline', '编译命令', @cmdline],
            ['force',   '全量编译', true],
            ['version', '版本号',   '']
        ...
        'bn_compile_win_iptn_nj'    => {
          :script_path  => 'bn/compile_win_iptn_nj.groovy',
          :parameters   => [
            ['cmdline', '编译命令', @cmdline],
            ['force',   '全量编译', true],
            ['version', '版本号',   '']
        ...
        'bn_compile_cpp_win_common' => {
          :script_path  => 'bn/compile_cpp_win_common.groovy',
          :parameters   => [
            ['cmdline', '编译命令', @cmdline_cpp],
            ['force',   '全量编译', true],
            ['version', '版本号',   '']
        ...
        'bn_compile_cpp_win_iptn'   => {
          :script_path  => 'bn/compile_cpp_win_iptn.groovy',
          :parameters   => [
            ['cmdline', '编译命令', @cmdline_cpp],
            ['force',   '全量编译', true],
            ['version', '版本号',   '']
        ...
        'bn_compile_cpp_win_naf'    => {
          :script_path  => 'bn/compile_cpp_win_naf.groovy',
          :parameters   => [
            ['cmdline', '编译命令', @cmdline_cpp],
            ['force',   '全量编译', true],
            ['version', '版本号',   '']
        ...
        'bn_compile_cpp_win_e2e'    => {
          :script_path  => 'bn/compile_cpp_win_e2e.groovy',
          :parameters   => [
            ['cmdline', '编译命令', @cmdline_cpp],
            ['force',   '全量编译', true],
            ['version', '版本号',   '']
        ...
        'bn_compile_cpp_win_wdm'    => {
          :script_path  => 'bn/compile_cpp_win_wdm.groovy',
          :parameters   => [
            ['cmdline', '编译命令', @cmdline_cpp],
            ['force',   '全量编译', true],
            ['version', '版本号',   '']
