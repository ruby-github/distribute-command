...
namespace :stn do
  ...
  namespace :patch do
    task :install, [:build_home, :code_home, :version, :display_version, :sp_next] do |t, args|
      ...
      if not Install::install_patch build_home, code_home, version, display_version, sp_next, 'stn'
        status = false
      end
